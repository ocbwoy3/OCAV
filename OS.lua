...
local bootEFIProxy = component.proxy(component.list("eeprom")())
local bootInternetProxy = component.proxy(component.list("internet")()) or nil
...
antivirus.load(consent, bootFilesystemProxy, bootEFIProxy, bootInternetProxy)
